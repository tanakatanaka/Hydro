...
Rect rect = {
	...
	3.0, 0.4, 0.4,       //obs_left, thick, width
//	0.2, 0.1, 0.1,       //obs_left, thick, width
	200,//nMeshX
	100 //nMeshY
};
...
void setupGLUI()
{
	...
	//left_edit->set_float_limits( 0.0, 10.0);
	...
	nMeshX_edit->set_int_limits( 50, 200);
	nMeshY_edit = new GLUI_EditText(paraPanel,"nMeshY", &rect.nMeshY);
	nMeshY_edit->set_int_limits( 20, 100);
