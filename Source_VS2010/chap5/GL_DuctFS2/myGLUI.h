...
Rect rect = {
	...
	0.3, 0.12, 0.12, 0.5,//obs_left, thickness, width, height
	100,//meshX
	50 //meshY
...
float tolerance = 0.001;//0.00001;//許容誤差
float deltaT = 0.002;
...
void setupGLUI()
{
	...
	new GLUI_Checkbox(dispPanel, "contoure", &flagOmega );
