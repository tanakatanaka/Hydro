...
2次元ポテンシャル流れ2
一様流れ+(湧出し+吸込み)+自由渦の速度ポテンシャル，流れ関数，速度ベクトル
粒子を速度ベクトルで動かす
*/
#include <windows.h>
#include <GL/glut.h>
...
int main(int argc, char** argv)
{
	...
	//ウィンドウ作成
	main_window = glutCreateWindow("GL_PotentialFlow2");//GLUIが対象とするウィンドウ
	//ウィンドウのサイズ変更
...
void calculate()
{
	...
	Vector2D z;
	float r1 = 0.0, r2 = 0.0;//２乗距離
	float x1 = 0.0, x2 = 0.0;//湧き出し点と吸い込み点
	float rad0 = 0.0015;
