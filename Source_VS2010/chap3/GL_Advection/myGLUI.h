...
void setupGLUI()
{
	...
	radioM = new GLUI_RadioGroup(methodPanel, &method, 3);
	new GLUI_RadioButton(radioM, "1st order");
	new GLUI_RadioButton(radioM, "2nd order");
	new GLUI_RadioButton(radioM, "CIP");
	new GLUI_RadioButton(radioM, "strict");
